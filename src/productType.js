...
async function updateProductRelations() {
  const startId = 979; //TODO: change the product ids after creating it
  const endId = 997; //TODO: change the product ids after creating it
  ...
  const PRODUCT_TYPE_ID = 9; //TODO: change the product type id
